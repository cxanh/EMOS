...
- 后端测试可运行
- Agent 语法检查可运行
- 告警、用户管理、报表、AI 分析与 AI Ops Phase 1A 已具备基础实现
...
- [Batch 8 Skill Catalog 只读版实施方案](/C:/Users/ASUS/Desktop/01_学习资料/毕设/EOMS/docs/ai-ops/BATCH_8_SKILL_CATALOG_PLAN.md)
- [Batch 8 Skill Catalog 任务清单](/C:/Users/ASUS/Desktop/01_学习资料/毕设/EOMS/docs/ai-ops/BATCH_8_TASKLIST.md)
...
- [ADR-004：Batch 8 Skill Catalog 只读决策](/C:/Users/ASUS/Desktop/01_学习资料/毕设/EOMS/docs/adr/ADR-004-batch-8-skill-catalog-readonly.md)

AI Ops 文档使用说明：

1. `PHASE_2_PLAN.md` 用于固定 Phase 2 的范围、边界、架构落点与批次顺序。
2. `PHASE_2_TASKLIST.md` 用于 Phase 2 各批次的执行拆分、文件清单与验收对照。
3. `BATCH_7_CHAT_ANALYSIS_PLAN.md` 用于固定 Batch 7 对话式 AI 分析页的页面、接口、上下文与短会话边界。
4. `BATCH_8_SKILL_CATALOG_PLAN.md` 用于固定 Batch 8 Skill Catalog 只读版的目录边界、数据来源、页面交互与导航关系。
5. `ADR-004` 用于固定 Batch 8 为什么采用“独立页 + 只读目录 + 跳转执行”的关键决策。
...
- 单一事实源：运行与发布状态以 [README](/C:/Users/ASUS/Desktop/01_学习资料/毕设/EOMS/README.md) 和本页为准
